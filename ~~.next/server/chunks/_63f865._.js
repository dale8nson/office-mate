...
const Page = async ()=>{
    ...
    let files = [];
    let folders = [];
    const getFolderMeta = async (folderMeta = [], pageToken = null)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$desktop$2f$cloud$2f$cloud$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getFiles"]('files(name,id,mimeType,parents),nextPageToken', 'mimeType%3d%27application/vnd.google-apps.folder%27', pageToken).then((meta)=>{
            const folders = [
            ...
            if (Object.hasOwn(meta, 'nextPageToken') && meta.nextPageToken !== pageToken) {
                getFolderMeta(folderMeta, meta.nextPageToken);
            }
            ...
            for (const folder of folderMeta){
                __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$desktop$2f$cloud$2f$cloud$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getFiles"]('files(id,name,mimeType,hasThumbnail,thumbnailLink,iconLink)', `%27${folder.id}%27+in+parents`).then((meta)=>{
                    ...
                    folderFileMap[folder.id] = meta.files;
                });
            }
            return folderFileMap;
        });
    };
    const folderFileMap = getFolderMeta();
...
//# sourceMappingURL=_63f865._.js.map